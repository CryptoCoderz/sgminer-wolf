...
static cl_int queue_hmq1725_kernel(struct __clState *clState, struct _dev_blk_ctx *blk, __maybe_unused cl_uint threads)
{
	cl_kernel *kernel = &clState->kernel;
	unsigned int num = 0;
	cl_ulong le_target;
	...
	// search13
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	CL_SET_ARG(clState->Branch7Nonces);
	CL_SET_ARG(clState->Branch8Nonces);
	CL_SET_ARG(clState->GlobalThreadCount);
	num = 0;
	// search14
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	...
	// search17
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	CL_SET_ARG(clState->Branch9Nonces);
	CL_SET_ARG(clState->Branch10Nonces);
	CL_SET_ARG(clState->GlobalThreadCount);
	num = 0;
	// search18
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	...
	// search21
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	CL_SET_ARG(clState->Branch11Nonces);
	CL_SET_ARG(clState->Branch12Nonces);
	CL_SET_ARG(clState->GlobalThreadCount);
	num = 0;
	// search22
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	...
	// search25
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	CL_SET_ARG(clState->Branch13Nonces);
	CL_SET_ARG(clState->Branch14Nonces);
	CL_SET_ARG(clState->GlobalThreadCount);
	num = 0;
	// search26
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	...
	// search29
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
	CL_SET_ARG(clState->Branch15Nonces);
	CL_SET_ARG(clState->Branch16Nonces);
	CL_SET_ARG(clState->GlobalThreadCount);
	num = 0;
	// search30
	CL_NEXTKERNEL_SET_ARG(clState->padbuffer8);
...
#define A_HMQ1725(a, b) \
  { a, ALGO_HMQ1725, "", 1, 65536, 65536, 0, 0, 0xFF, 0xFFFFFFULL, 0x0000ffffUL, 32, 8 * 16 * 4194304, CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE, b, queue_hmq1725_kernel, gen_hash, append_x11_compiler_options }
